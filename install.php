...
{
    $version = get_version();
    Db::import(file_get_contents("system/storage/db/v4.sql"));
    header("location: ".$GLOBALS["_SETTINGS"]["ADMINPATH"]."/installation?v="._version);
}
...
<html>
	<head>
		<title>Surfow - Installation</title>
		<meta charset="utf-8" />
    ...
    <h1 style="color: #fff; text-align: center; font-size: 4em;" >Installation</h1>
    <center>
    <a href="Javascript::void(0);" onclick="window.location = '<?php echo $_SERVER["PHP_SELF"]; ?>?process=install';" class="button scrolly">Install</a>
    </center>
    <ul class="copyright">
